...
def gen_grid(): 
    ...
    # grid = np.array([
    #         [0.1, 0.1, 0.2, 0.2, 0.3, 0.0, 0.3, 0.1, 0.1, 0.2],
    #         [0.1, 0.1, 0.1, 0.2, 0.1, 0.0, 0.2, 0.1, 0.1, 0.2],
    #         [0.1, 0.0, 0.2, 0.1, 0.9, 0.9, 0.2, 0.1, 0.1, 0.2],
    #         [0.1, 0.1, 0.0, 0.1, 0.9, 0.9, 0.2, 0.5, 0.3, 0.4],
    #         [0.1, 0.1, 0.2, 0.2, 0.1, 0.1, 0.1, 0.2, 0.1, 0.1],
    #         [0.9, 0.9, 0.9, 0.4, 0.1, 0.1, 0.4, 0.9, 0.9, 0.9],
    #         [0.9, 0.7, 0.8, 0.9, 0.2, 0.1, 0.9, 0.7, 0.8, 0.9],
    #         [0.9, 0.8, 0.8, 0.9, 0.0, 0.0, 0.9, 0.8, 0.8, 0.9],
    #         [0.9, 0.9, 0.8, 0.0, 0.0, 0.0, 0.0, 0.8, 0.9, 0.9],
    #         [0.9, 0.9, 0.2, 0.0, 0.0, 0.0, 0.0, 0.8, 0.9, 0.9]
    #         ])
